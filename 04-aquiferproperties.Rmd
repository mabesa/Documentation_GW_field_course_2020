...
```{r setup-pumping-test, echo = FALSE, fig.width='100%', fig.cap='Setup of the pumping tests during field course 2019. Drawing by Baume, Gardenghi, Formakova, Huber and Cracknell.'}
...
```{r pumping-test-pressure-signals, echo=FALSE}
...
ggplot() + 
  geom_point(aes(Time,Diff),size=0.2) +
  facet_wrap('Borehole', scales = 'free_y')+
  labs(y='Pressure change [bar]')
```
