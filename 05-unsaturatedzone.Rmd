...
The weather data from the station in Kappelen in given in Figure \@ref(fig:weather-data-Kappelen).  
...
Using simplified water balance model:   
Recharge = Precipitation - Evaportranspiration - Runoff    
Note: Assume that surface runoff can be neglected. Daily time series of precipitation and evapotranspiration are available [here]('_bookdown_files/data/Unsaturated_zone_processes/daily_ET_Precip_in_mm.csv').    
